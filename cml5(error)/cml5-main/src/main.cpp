...
#define OUT_LEN 3
#define HID_LEN 3
#include "/root/cml5/include/hidden_nn.h"
#include "/root/cml5/src/hidden_nn.cpp"
...
int main()
{
    ...
    printf("Active Error : %f \r\n",find_error_simple(predicted_results[ACTIVE_QUALITY_PREDICTION_IDX], expected_values[ACTIVE_QUALITY_PREDICTION_IDX]));
    return 0;
}